---
title: "Bank Marketing Final Project - Jesslyn Widjaja"
author: "PSTAT 131, Winter 2017"
...
The pruned decision tree leads to 89% of correct predictions, which is a bit more accurate than the original decision tree at 88%. It is also the most accurate prediction and takes the least amount of computing time out of all the models, so this is the one I choose.   
...
For further study, I can also perform randomForest or logistic regression given the features selected from the decision tree to see if it gives a higher probability of correctly predicting subscriptions and non-subscriptions. 
